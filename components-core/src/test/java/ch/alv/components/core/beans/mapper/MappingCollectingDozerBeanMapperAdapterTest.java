...
/**
 * Unit tests for the {@link MappingCollectingDozerBeanMapperAdapter}.
 *
 * @since 1.0.0
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = "classpath:mapper-test.xml")
public class MappingCollectingDozerBeanMapperAdapterTest {
    ...
    @Autowired
    private MappingCollectingDozerBeanMapperAdapter mapper;
