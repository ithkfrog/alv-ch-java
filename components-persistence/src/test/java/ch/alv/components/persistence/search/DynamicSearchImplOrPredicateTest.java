 ...
 * @since 1.0.0
 */
public class DynamicSearchImplOrPredicateTest {

    @Test
    public void testPredicate() {
        DynamicSearch search = new DynamicSearchImpl().where("a", "firstAttribute").or("b", "secondAttribute");
    ...
    public void testImmutablePredicateValue() {
        ...
        DynamicSearch search = new DynamicSearchImpl().where("a", "firstAttribute").or("b", "secondAttribute", immutableValue);
    ...
    public void testComparatorType() {
        DynamicSearch search = new DynamicSearchImpl().where("a", "firstAttribute").or("b", "secondAttribute", ComparatorType.NOT_EQUALS);
    ...
    public void testComparatorTypeAndImmutablePredicateValue() {
        String immutableValue = "testImmutableValue";
        DynamicSearch search = new DynamicSearchImpl().where("a", "firstAttribute").or("b", "secondAttribute", ComparatorType.NOT_EQUALS, immutableValue);
    ...
    public void testPredicateList() {
        ...
        DynamicSearch search = new DynamicSearchImpl().where("a", "firstAttribute").or(list);
    ...
    public void testPredicateGroup() {
        ...
        DynamicSearch search = new DynamicSearchImpl().where("a", "firstAttribute").or(group);
