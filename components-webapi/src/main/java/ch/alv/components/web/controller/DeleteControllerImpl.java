...
public class DeleteControllerImpl extends BasePersistingController implements DeleteController {

    private static final Logger LOG = LoggerFactory.getLogger(DeleteControllerImpl.class);
    ...
    public Object handleDeleteRequest(HttpServletRequest request,
        ...
        if (id == null) {
            return new BadRequestException("The id must not be null!");
        }
