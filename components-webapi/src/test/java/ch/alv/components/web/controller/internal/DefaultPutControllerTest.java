...
public class DefaultPutControllerTest {
    ...
    public void testCreate() throws UnauthorizedException {
        MockFactoryTestEntity response = (MockFactoryTestEntity) controller.handlePutRequest(request, "controllerTestModule", "controllerTestStore", "{ \"version\": 55}");
    ...
    public void testUpdate() throws UnauthorizedException {
        MockFactoryTestEntity response = (MockFactoryTestEntity) controller.handlePutRequest(request, "controllerTestModule", "controllerTestStore", "{ \"id\": \"postUpdateId\", \"version\": 55}");
    ...
    public void testUpdateFail() throws UnauthorizedException {
        ...
        controller.handlePutRequest(request, "controllerTestModule", "controllerTestStore", "{ \"id\": \"postUpdateId\" \"version\": 55}");
    }

    @Test
    public void testCreateWithId() throws UnauthorizedException {
        MockFactoryTestEntity response = (MockFactoryTestEntity) controller.handlePutRequest(request, "controllerTestModule", "controllerTestStore", "anotherPostTestId", "{ \"version\": 55}");
    ...
    public void testUpdateFailWithId() throws UnauthorizedException {
        ...
        controller.handlePutRequest(request, "controllerTestModule", "controllerTestStore", "{ \"version\": 55,}");
    }

    public class TestAuthentication implements Authentication {

        private static final long serialVersionUID = 4872656779760506237L;
    ...
    public class TestUserDetails implements UserDetails {
        ...
        private static final long serialVersionUID = 374032987982332004L;
