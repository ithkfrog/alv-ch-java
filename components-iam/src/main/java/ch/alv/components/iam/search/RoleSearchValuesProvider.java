...
/**
 * {@link ch.alv.components.persistence.search.ValuesProvider} for {@link ch.alv.components.iam.model.Role} entities.
 *
 * @since 1.0.0
 */
public class RoleSearchValuesProvider extends BaseWebValuesProvider {
